...
- Optional commands for Claude Code, Codex cli, Cursor cli, and Gemini cli that you can enable individually — each reuses the same terminal app and runs `claude`, `codex`, `agent`, or `gemini` respectively.
...
- **Enable Claude Code / Codex cli / Cursor cli / Gemini cli** – toggles that add the corresponding commands to the palette.
